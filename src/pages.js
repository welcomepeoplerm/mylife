    ...
    <div class="assistant-container">
      <div class="chat-placeholder">
        ...
        <div class="contact-info">
          <a href="https://wa.me/393917557924" target="_blank" rel="noopener noreferrer" class="btn btn-whatsapp">
          ...
          <a href="tel:+393917557924" class="btn btn-secondary">
            ${getSectorIcon('phone')}
            Chiamaci
          </a>
          <a href="mailto:gozzolif@gmail.com" class="btn btn-secondary">
            ${getSectorIcon('email')}
            Email
          </a>
        </div>
